...
<nav class="nav navbar-expand-md navbar-dark bg-secondary">
    <ul class="nav navbar-nav nav-fill w-100">
        ...
        <li class="nav-item">
            <a class="nav-link " href="../pds/list.jsp">자료실</a></li>
        <li class="nav-item">
            <a class="nav-link" href="../gallery/list.jsp">갤러리</a></li>
        <li class="nav-item">
            <a class="nav-link" href="admin.jsp">관리자</a></li>
    </ul>
</nav>